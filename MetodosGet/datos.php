...
include('connection.php'); // Incluye el archivo de conexión a la base de datos
 // fijamos la zona horaria correspondiende para servidor remoto:
// date_default_timezone_set('America/Bogota'); 

echo '<link rel="stylesheet" href="css/bootstrap.min.css">'; // Movido después de la etiqueta de apertura 


$sql = "SELECT id, sensorName, location, readValue, reading_time FROM sensordata ORDER BY id DESC LIMIT 10";
//$sql = "SELECT id, sensor, location, turbidez, reading_time FROM sensor_turbidez ORDER BY id DESC";
